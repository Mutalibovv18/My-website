...
import studio from '../components/images/studio.jpeg'
const Home = () => {
  const fadeInUp = {
            ...
            {[
              {
                ...
                answer: "There's absolutely no catch! We've built an incredible team of experts to help e-commerce brands grow. Your brand should be making at least $50,000 MRR to partner with us. We offer lots of value since we genuinely want to help you grow, even if we don't end up partnering."
              },
              {
              ...
              },
              {
                ...
                answer: "Our fee structure is individual to each client and depends on what you need and what your goal is. You can join our demo session so we can help identify your email marketing strategy and help you acquire at least 3x more customers for a minimum CAC and maximum ROI."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
